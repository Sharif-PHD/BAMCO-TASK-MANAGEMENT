(()=>{
  ...
  document.documentElement.dataset.uiHotfix='20260907-user3';
  ...
  function refreshStableLayout(){
    ...
    const l=document.createElement('link');l.rel='stylesheet';l.href='stable-layout-20260906.css?v=20260907-user3';l.dataset.finalLayout='1';document.head.appendChild(l);
  }

  function installGroupedSidebar(){
    if(document.querySelector('script[data-sidebar-groups]'))return;
    const s=document.createElement('script');s.src='sidebar-groups-20260906.js?v=20260907-user3';s.dataset.sidebarGroups='1';document.body.appendChild(s);
  }

  function installUserRequestedFixes(){
    if(document.querySelector('script[data-user-request-fixes]'))return;
    const s=document.createElement('script');s.src='user-request-fixes-20260907.js?v=20260907-3';s.dataset.userRequestFixes='1';document.body.appendChild(s);
  }

  function installUserRequestedFixesV2(){
    if(document.querySelector('script[data-user-request-fixes-v2]'))return;
    const s=document.createElement('script');s.src='user-request-fixes-20260907-v2.js?v=20260907-1';s.dataset.userRequestFixesV2='1';document.body.appendChild(s);
  }
