(()=>{
  ...
  document.documentElement.dataset.uiHotfix='20260907-user5';
  ...
  function refreshStableLayout(){
    ...
    const l=document.createElement('link');l.rel='stylesheet';l.href='stable-layout-20260906.css?v=20260907-user5';l.dataset.finalLayout='1';document.head.appendChild(l);
  }
  ...
  function installSidebarUniformStyle(){
    ...
    l.rel='stylesheet';
    l.href='sidebar-uniform-20260907.css?v=20260907-user1';
  ...
  function installGroupedSidebar(){
    ...
    const s=document.createElement('script');s.src='sidebar-groups-20260906.js?v=20260907-user5';s.dataset.sidebarGroups='1';document.body.appendChild(s);
  }

  function installUserRequestedFixesV2(){
    if(document.querySelector('script[data-user-request-fixes-v2]'))return;
    const s=document.createElement('script');s.src='user-request-fixes-20260907-v2.js?v=20260907-user5';s.dataset.userRequestFixesV2='1';document.body.appendChild(s);
  }
