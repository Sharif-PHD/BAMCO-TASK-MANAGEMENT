...
(()=>{
 ...
 window.fetch=async(input,init={})=>{
  ...
  if(endpoint==='sent_message_log')return json([
   {log_key:'delivery:30',source_type:'delivery',source_id:'30',recipient_id:owner.id,recipient_name:owner.full_name,subject:'گزارش روزانه آزمایشی',channel:'portal',delivery_status:'sent',sent_at:iso,attempt_count:1,error_message:null,thread_key:'TEST',sender_id:manager.id,sender_name:manager.full_name,snapshot_id:501,portal_message_id:701},
   {log_key:'portal_event:702',source_type:'portal_event',source_id:'702',recipient_id:owner.id,recipient_name:owner.full_name,subject:'به‌روزرسانی وظیفه',channel:'portal',delivery_status:'delivered',sent_at:iso,attempt_count:0,error_message:null,thread_key:'TASK-1',sender_id:manager.id,sender_name:'سامانه',snapshot_id:null,portal_message_id:702}
  ]);
