...
begin
 ...
 select coalesce(array_agg(id),array[]::bigint[]) into active_ids from public.tasks where owner_id=p_user_id and not archived and status not in ('انجام شده','متوقف');
