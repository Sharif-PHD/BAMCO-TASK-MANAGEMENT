(()=>{
  ...
  let selectionRaf=0;const tableObserver=new MutationObserver(()=>{if(selectionRaf)return;selectionRaf=requestAnimationFrame(()=>{selectionRaf=0;moveSelectionToRight()})});
