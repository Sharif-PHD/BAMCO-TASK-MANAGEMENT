...
(()=>{
  ...
  async function loadPeople(){people=await select('profiles','select=id,email,full_name,display_name,role,gender,salutation,active,default_message_channel&order=full_name');state.profiles=people;renderPeople()}
