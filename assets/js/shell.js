...
(()=>{
  ...
  async function loadPeople(){people=await select('profiles','select=id,email,full_name,display_name,role,gender,salutation,active&order=full_name');renderPeople()}
