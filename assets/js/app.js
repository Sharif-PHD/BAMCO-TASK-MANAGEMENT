...
function syncTaskState(){
  ...
  f.elements.owner_id.disabled=registered||!isManager()||!!(state.editing?.archived&&state.editing?.owner_deleted_at);f.elements.owner_id.required=status==='در حال انجام';
