(()=>{
  ...
  function loadRuntime(){
    ...
    addScript('assets/js/production-runtime.js?v=20260909-release-1','__bamcoSafeRuntimeLoading',()=>{
      window.__bamcoSafeRuntimeLoaded=true;
      addScript('assets/js/tab-workspace.js?v=20260909-release-1','__bamcoTabsLoading');
      addScript('assets/js/completion-ui.js?v=20260909-release-1','__bamcoCompletionUiLoading',()=>{window.__bamcoCompletionUiLoaded=true});
    });
