...
function ensureStyles(){
  ...
  const s=document.createElement('style');s.id='bamcoResponseTrackingRootCss';s.textContent=`
    ...
    #responseTrackingView #reminderSendChannel{order:5}
    #responseTrackingView #responsePerson{order:6}
    #responseTrackingView #responseChannel{order:7}
    #responseTrackingView #responseState{order:8}
    #responseTrackingView #sendResponseReminder{order:9}
    #responseTrackingView .response-command-row select{min-width:125px;height:38px}
